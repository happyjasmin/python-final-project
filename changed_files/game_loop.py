...
def First_scene():
	...
	jailImg = pygame.transform.scale(jailImg, (900, 900))
	principleImg = pygame.transform.scale(principleImg, (900, 900))


	jail_object=figure(190,0,900,900)
	principle_object=figure(190,0,900,900)
	...
	while not to_stage1:
		...
		jail_object.set(jailImg)
		principle_object.set(principleImg)
...
### game exit while loop
	...
	while not gameExit:
		...
		if collision(boat,endline):
			#gameExit = True
			Ending_Trailer2(now_gpa.content)
